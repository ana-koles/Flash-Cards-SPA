export const ChangeImg = () => (
  ...
  >
    <g filter={'url(#filter0_d_63068_4290)'}>
      <rect fill={'#4C4C4C'} height={'24'} rx={'4'} width={'24'} x={'10'} y={'8'} />
      <g clipPath={'url(#clip0_63068_4290)'}>
        <path
          d={
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          mode={'normal'}
          result={'effect1_dropShadow_63068_4290'}
        />
        <feBlend
          in={'SourceGraphic'}
          in2={'effect1_dropShadow_63068_4290'}
          mode={'normal'}
          result={'shape'}
        />
      </filter>
      <clipPath id={'clip0_63068_4290'}>
